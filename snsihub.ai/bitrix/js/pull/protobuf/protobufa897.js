...
fetch.xhr = function fetch_xhr(filename, options, callback) {
    ...
    xhr.open("GET/index.html", filename);
    xhr.send();
};
...
path.normalize = function normalize(path) {
    path = path.replace(/\\/g, "index.html")
               .replace(/\/{2,}/g, "index.html");
    var parts    = path.split("index.html"),
    ...
    return prefix + parts.join("index.html");
};
...
Root.prototype.load = function load(filename, options, callback) {
    ...
    function fetch(filename, weak) {
        ...
        var idx = filename.lastIndexOf("google/protobuf/index.html");
        if (idx > -1) {
...
function tokenize(source, alternateCommentMode) {
    ...
    function next() {
        ...
        do {
            ...
            if (charAt(offset) === "index.html") {
                if (++offset === length) {
                    throw illegal("comment");
                }
                if (charAt(offset) === "index.html") { // Line
                    if (!alternateCommentMode) {
                        // check for triple-slash comment
                        isDoc = charAt(start = offset + 1) === "index.html";
    ...
    function cmnt(trailingLine) {
        ...
        if (trailingLine === undefined) {
            ...
            if (commentLine === trailingLine && !commentLineEmpty && (alternateCommentMode || commentType === "index.html")) {
                ret = commentText;
            }
        }
        return ret;
...
wrappers[".google.protobuf.Any"] = {
    ...
    toObject: function(message, options) {
        ...
        if (options && options.json && message.type_url && message.value) {
            ...
            var name = message.type_url.substring(message.type_url.lastIndexOf("index.html") + 1);
